...
from execution.market_data import OhlcvRepository
from execution.okx_client import OkxClient, OkxCredentials
from execution.state_store import StateStore
from simple_backtest.ema_cross_volume_core import EmaCrossVolumeConfig, EmaCrossVolumeEngine
from simple_backtest.scalp_robust_v2_core import (
    ActionType,
    ScalpRobustEngine,
    StrategyAction,
    StrategyConfig,
...
class ExecutorConfig:
    ...
    pos_side: str = "long"
    data_root: str = "user_data/data/okx/futures"
    rr_ratio: float = 4.0
