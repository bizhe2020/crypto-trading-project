...
class ExecutorConfig:
    ...
    def to_scalp_strategy_config(self) -> StrategyConfig:
        return StrategyConfig(
            ...
            normal_stage1_lock_r=self.normal_stage1_lock_r,
            normal_stage2_trigger_r=self.normal_stage2_trigger_r,
            normal_stage2_lock_r=self.normal_stage2_lock_r,
            tight_stage0_trigger_r=self.tight_stage0_trigger_r,
            tight_stage0_lock_r=self.tight_stage0_lock_r,
            tight_stage1_trigger_r=self.tight_stage1_trigger_r,
            tight_stage1_lock_r=self.tight_stage1_lock_r,
