...
class OkxExecutionEngine:
    ...
    def _configured_fvg_bear6_exit_profile_overrides(self) -> dict[str, Any]:
        configured = getattr(self.config, "fvg_bear6_loose_exit_profile_overrides", None)
    ...
    def _fvg_bear6_loose_exit_profile_decision(self, action: StrategyAction) -> dict[str, Any]:
        bucket_name = str(
            getattr(self.config, "fvg_bear6_loose_exit_profile_bucket", FVG_BEAR6_LOOSE_EXIT_PROFILE_BUCKET)
            or FVG_BEAR6_LOOSE_EXIT_PROFILE_BUCKET
        )
        profile_name = str(
            getattr(self.config, "fvg_bear6_loose_exit_profile_name", FVG_BEAR6_LOOSE_EXIT_PROFILE_NAME)
            or FVG_BEAR6_LOOSE_EXIT_PROFILE_NAME
        )
        decision: dict[str, Any] = {
            "enabled": bool(getattr(self.config, "enable_fvg_bear6_loose_exit_profile_live", False)),
            "applied": False,
